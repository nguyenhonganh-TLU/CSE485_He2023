...
<body>
    ...
    <div class="card">
        ...
        <div class="card-body">
            <form method="post" action="{{ route('channels.show', $channel->id) }}" enctype="multipart/form-data">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                        ...
                        value="{{ $channel-> channelName}}" readonly />
                    </div>
                </div>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                        ...
                        value="{{ $channel->description }}" readonly />
                    </div>
                </div>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                        ...
                        value="{{ $channel->subscribersCount }}" readonly />
                    </div>
                </div>
                <div class="row mb-3">
